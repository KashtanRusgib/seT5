/**
 * @file trit_emu.h
 * @brief seT6 Ternary Emulation — 2-bit Packed Structs & SIMD Intrinsics
 *
 ...
 *
 * Reference: Setun computer (Brusentsov, 1958); seT6 INITIAL_PROJECT_ANSWERS
 *            AFP "Three-Valued Logic" — Kleene lattice meet/join as min/max
 *
 * SPDX-License-Identifier: GPL-2.0
 */

#ifndef SET6_TRIT_EMU_H
#define SET6_TRIT_EMU_H
