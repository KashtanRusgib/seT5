 ...
 * @brief seT6 Ternary Weight Quantizer (TWQ) — BitNet b1.58 Engine
 *
...
#ifndef SET6_TERNARY_WEIGHT_QUANTIZER_H
#define SET6_TERNARY_WEIGHT_QUANTIZER_H
...
#endif /* SET6_TERNARY_WEIGHT_QUANTIZER_H */
