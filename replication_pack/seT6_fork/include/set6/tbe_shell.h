 ...
 *
 * A minimal interactive shell for the seT6 microkernel, providing:
...
#ifndef SET6_TBE_SHELL_H
#define SET6_TBE_SHELL_H
...
static inline void tbe_run(tbe_state_t *tbe) {
    ...
    printf("\nseT6 TBE — Ternary Bootstrap Environment v0.1\n");
