/**
 * @file trit_cast.h
 * @brief seT6 Ternary Casting — Portable Runtime Helpers
 *
 ...
 *
 * A seT6-patched Clang would inline these as intrinsics.
...
#ifndef SET6_TRIT_CAST_H
#define SET6_TRIT_CAST_H
