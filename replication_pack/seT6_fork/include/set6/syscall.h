/**
 * @file syscall.h
 * @brief seT6 Syscall Dispatch — Central Kernel Entry Point
 *
 ...
 *
 * Syscall numbers are canonical — defined in set6.h (tools/compiler/include).
 * This module glues the memory, IPC, and scheduler modules together.
 *
 * @see set6.h for syscall number definitions
 * @see ARCHITECTURE.md §8 — Syscall ABI
 *
 * SPDX-License-Identifier: GPL-2.0
 */

#ifndef SET6_SYSCALL_H
#define SET6_SYSCALL_H
...
/* ---- Syscall numbers (canonical — from set6.h) ------------------------ */
