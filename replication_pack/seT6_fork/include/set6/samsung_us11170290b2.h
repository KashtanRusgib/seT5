 ...
 * @brief seT6 Hardware Abstraction for Samsung US11170290B2 NAND Inference Chip
 *
 ...
 *   Samsung binary weights {-1, +1} are a subset of seT6 trit values.
 *
...
#ifndef SET6_SAMSUNG_US11170290B2_H
#define SET6_SAMSUNG_US11170290B2_H
 ...
 *   Weight -1: FG1=programmed("0"), FG2=erased("1")
 *
 * We use int8_t for consistency with seT6 trit, but only ±1 valid.
 */
...
/* ===================================================================== */
/* Ternary Input Type (maps directly to seT6 trit)                       */
/* ===================================================================== */

/**
 * Samsung TBN inputs are ternary: {-1, 0, +1}.
 * These map directly to seT6 `trit` type without translation.
 *
...
#endif /* SET6_SAMSUNG_US11170290B2_H */
