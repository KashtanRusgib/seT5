 ...
 *   - include/set6/tsmc_tmd.h      (monolayer, heterostack, FET, 3D)
 *   - include/set6/intel_pam3_decoder.h  (11-stage PAM-3 pipeline)
 *   - include/set6/hynix_tcam.h    (TCAM search, MAC, DFP, GNN)
 *
...
#include "set6/tsmc_tmd.h"
#include "set6/intel_pam3_decoder.h"
#include "set6/hynix_tcam.h"
