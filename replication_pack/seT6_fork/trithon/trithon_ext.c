 ...
 * Wraps the real seT6 trit.h / multiradix.h / trit_emu.h APIs so
...
/**
 * Full multi-radix DOT_TRIT via the seT6 engine.
...
/**
 * Full multi-radix FFT_STEP via the seT6 engine.
