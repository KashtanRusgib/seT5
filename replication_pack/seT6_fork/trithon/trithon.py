# Trithon — Python CFFI Bindings for seT6 Balanced Ternary
# SPDX-License-Identifier: GPL-2.0

"""
Trithon: Python interface to seT6 balanced ternary operations.
...
class QEMUNoise:
    ...
    Mirrors include/set6/qemu_trit.h for testing without C compilation.
    """
...
def _self_test():
    ...
    if native_available():
        # Multi-radix DOT via seT6 engine
