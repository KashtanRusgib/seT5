...
- `include/`: Headers (ternary.h, vm.h, parser.h, codegen.h, logger.h, ir.h, memory.h, set6.h, bootstrap.h, sel4_verify.h, test_harness.h).
...
2. **Phase 2 (seT6):** Pointers/memory, syscalls, Verilog sim, self-host, seL4 verify *(DONE)*
...
## Build Stats
- **Test suites**: 19 (trit, lexer, parser, codegen, vm, logger, ir, sel4, integration, memory, set6, bootstrap, sel4_verify, hardware, basic, typechecker, linker, arrays, selfhost)
- **Total tests**: 286+
