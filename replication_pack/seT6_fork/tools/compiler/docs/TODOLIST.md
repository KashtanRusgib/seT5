...
2. [DONE] TASK-016: Syscall stubs for seT6. — include/set6.h: 10 syscall numbers, seT6_cap struct, 5 capability rights, seT6_obj_type enum. VM OP_SYSCALL dispatch (t_exit, t_write, t_read, t_mmap, t_cap_send, t_cap_recv). t_cap_grant/t_cap_revoke API. 13 tests in test_set6.c.
