 ...
 * a subset of C (seT6-C) to ternary bytecode. The key test is
 * compiling a mini-tokenizer written in seT6-C and running it
 * on the VM.
 */
...
/*
 * Mini-tokenizer source in seT6-C subset.
