 ...
 * subset of its own source code (a tokenizer written in seT6-C) to
 ...
 *   1. The seT6-C tokenizer source is compiled by bootstrap_compile()
...
/*
 * The self-hosted tokenizer source in seT6-C.
 *
