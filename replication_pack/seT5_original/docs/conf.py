# -*- coding: utf-8 -*-
"""
seT5 Documentation Configuration — Sphinx + Doxygen (Breathe)

Generates API docs from Doxygen-annotated C headers and proof stubs.
Supports C and Rust (via domains) for the seT5 ternary compiler project.
...
project = 'seT5 — Secure Embedded Ternary Microkernel'
copyright = '2026, seT5 Contributors'
author = 'seT5 AI Swarm'
version = '0.1.0'
...
# breathe_projects = { 'seT5': '../doxygen/xml' }
# breathe_default_project = 'seT5'
