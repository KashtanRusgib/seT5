/**
 * @file init.c
 * @brief seT5 Kernel Init — Bootstrap for Balanced Ternary Microkernel
 *
 ...
 *
 * Build (native test):  make set5_native
 * Build (ternary):      make build-set5
 *
...
void set5_init(void) {
    ...
    /* ==== Summary ====================================================== */
    printf("\n========================================\n");
    printf("seT5 boot: %d tests, %d passed, %d failed\n",
           tests_run, tests_passed, tests_failed);
    printf("========================================\n");

    if (tests_failed == 0) {
        printf("seT5: ALL TESTS PASSED. Kernel operational.\n");
    } else {
        printf("seT5: %d FAILURES. See above.\n", tests_failed);
    }
}
