/**
 * @file stt_mram.h
 * @brief seT5 STT-MRAM Ternary Memory Interface — Out-of-Band Memory Module
 *
 ...
 * or {-1, 0, +1} (balanced).
 *
 * The module interfaces with the seT5 microkernel through the existing IPC
...
#ifndef SET5_STT_MRAM_H
#define SET5_STT_MRAM_H
