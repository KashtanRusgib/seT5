# seT5 Solutions & Resources Index
...
- **Runtime:** `trit_not(trit_and(a,b)) == trit_or(trit_not(a), trit_not(b))` in `include/set5/trit.h`
...
|--------------------|--------------------------------------------------------------|-------------------------------------------|
| Clang source       | https://github.com/llvm/llvm-project/tree/main/clang        | Fork target for seT5 extensions           |
...
|------------------------------|------------------------------------|----------------------------------------------------|
| `include/set5/trit.h`       | Core types + Kleene ops            | `trit_and`, `trit_or`, `trit_not`, `trit_pack`    |
| `include/set5/trit_cast.h`  | Bool <-> Trit casting              | `trit_from_bool`, `trit_to_bool_strict`            |
| `include/set5/trit_type.h`  | Type safety + checked construction | `trit_checked`                                     |
| `include/set5/trit_emu.h`   | 2-bit packed SIMD                  | `trit2_and`, `trit2_reg32_and_bulk`                |
