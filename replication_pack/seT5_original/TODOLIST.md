# seT5 Task List — Sequential Roadmap (Easy-First)

> Last updated: 2026-02-14 — **seT5 FROZEN** — All development continues in seT6
> Legend: DONE | ACTIVE | PENDING
> Hardware targets: Huawei CFET, Samsung CMOS-ternary, memristive 1T1M, FPGA

---

> ### ⚠️ FROZEN — seT5 development complete
>
> seT5 achieved 0 errors and is preserved as-is. The **seT6** fork (in `seT6/`)
> inherits this entire roadmap and all future tasks. See `seT6/TODOLIST.md` for
...
| 1.13 | Fix syscall number conflict (init.c ↔ set5.h)        | Easy     | 1.12      | DONE    | Synthesizer|
...
| 2.10| End-to-end demo: compile with seT5-Clang       | Hard     | 2.5-2.9   | DONE    | Optimizer   |
...
| Phase 2 → 3  | Kernel modules (memory, IPC, scheduler) functional; `trit_demo.c` compiles under seT5-Clang |
...
| Date       | Industry Milestone                              | seT5 Target              |
|------------|------------------------------------------------|--------------------------|
