...
> across **66 active test suites**. See the glossary for the mandatory 4-step
> checklist: glossary → Makefile → run_all_tests.sh → `make alltest`.

---

# seT5 Task List — Sequential Roadmap (Easy-First)

> Last updated: 2026-06-13 — Phase 5 complete (Moonshot validated, 376 tests pass)
