/**
 * @file samsung_tseq.h
 * @brief seT5 Ternary Sequence Engine — Samsung CN105745888A
 *
 ...
 *
 * Mapping to seT5:
 *   seT5 balanced ternary {-1, 0, +1} maps directly to the ternary
...
#ifndef SET5_SAMSUNG_TSEQ_H
#define SET5_SAMSUNG_TSEQ_H
...
/**
 * A ternary sequence element — alias for seT5 trit.
