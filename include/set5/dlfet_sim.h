/**
 * @file dlfet_sim.h
 * @brief seT5 Doping-Less FET with Resistive Memory (DLFET-RM) Simulator
 *
 ...
 * with conversion to/from balanced ternary {-1, 0, +1} for seT5 integration.
 *
...
#ifndef SET5_DLFET_SIM_H
#define SET5_DLFET_SIM_H
