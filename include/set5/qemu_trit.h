/**
 * @file qemu_trit.h
 * @brief seT5 QEMU Extension — Ternary Noise Simulation
 *
 ...
 * propagation guarantees. A correct seT5 kernel must function
...
#ifndef SET5_QEMU_TRIT_H
#define SET5_QEMU_TRIT_H
