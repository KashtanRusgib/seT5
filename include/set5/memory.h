/**
 * @file memory.h
 * @brief seT5 Physical Memory Manager — Ternary Page Allocator
 *
...
#ifndef SET5_MEMORY_H
#define SET5_MEMORY_H
...
#define SET5_PAGE_TRITS   729

/** Maximum physical pages */
#define SET5_MAX_PAGES    256
...
typedef struct {
    trit  data[SET5_PAGE_TRITS];     /**< Trit contents (Unknown-init) */
...
typedef struct {
    set5_page_t pages[SET5_MAX_PAGES];
 ...
 * @param num_pages  Number of physical pages to manage (≤ SET5_MAX_PAGES).
 */
 ...
 * @param offset    Trit offset within page (0..SET5_PAGE_TRITS-1).
