 ...
 * operands, each trit occupies 2 bits (matching seT5 trit2 encoding
...
#ifndef SET5_HUAWEI_MMIO_H
#define SET5_HUAWEI_MMIO_H
 ...
 * For emulation, a fixed address within the seT5 virtual address space.
 */
#ifndef HW_MMIO_BASE
