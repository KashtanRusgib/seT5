 ...
 * @brief seT5 Hardware Abstraction for Huawei CN119652311A Ternary Chip
 *
 ...
 *   Translation:  huawei_val = seT5_val + 1
 *                 seT5_val   = huawei_val - 1
 *
...
#ifndef SET5_HUAWEI_CN119652311A_H
#define SET5_HUAWEI_CN119652311A_H
 ...
 *
 * seT5 uses balanced ternary {-1, 0, +1}.
 * Conversion: hw = balanced + 1,  balanced = hw - 1.
 */

typedef uint8_t hw_trit;   /**< Huawei logic value: 0, 1, or 2 */

#define HW_TRIT_0   ((hw_trit)0)   /**< Huawei logic 0 (= seT5 FALSE/-1)  */
#define HW_TRIT_1   ((hw_trit)1)   /**< Huawei logic 1 (= seT5 UNKNOWN/0) */
#define HW_TRIT_2   ((hw_trit)2)   /**< Huawei logic 2 (= seT5 TRUE/+1)   */

/* ---- Balanced ↔ Unbalanced Conversion -------------------------------- */

/**
 * @brief Convert seT5 balanced trit {-1,0,+1} to Huawei {0,1,2}.
 */
...
/**
 * @brief Convert Huawei {0,1,2} to seT5 balanced trit {-1,0,+1}.
 */
...
/**
 * @brief Convert a seT5 2-bit packed trit to Huawei hw_trit.
 *
 * seT5 trit2 encoding: 00=-1(F), 01=0(U), 11=+1(T), 10=fault
...
/**
 * @brief Convert Huawei hw_trit to seT5 2-bit packed trit.
 */
...
#endif /* SET5_HUAWEI_CN119652311A_H */
