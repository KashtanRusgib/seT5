...
- [x] **T-077** Create `CONTRIBUTING.md` — contributor guide: code style (C99, trit-first), commit conventions, Sigma gate (100% pass mandatory), Crown Jewel immutability, Gödel Machine RSI integration, AI prompt templates. (Value: 8; Batch: 16/5; **DONE** 2026-02-20)
