...
| 2.5 | Clang `BuiltinTritType` — builtin keyword     | Hard     | 1.5       | DONE    | Synthesizer |
| 2.6 | Clang Sema: operator restrictions              | Medium   | 2.5       | DONE    | Synthesizer |
| 2.7 | Clang Sema: casting rules                      | Medium   | 2.5       | DONE    | Synthesizer |
| 2.8 | Clang Parse: `#pragma ternary` handler         | Easy     | 2.5       | DONE    | Synthesizer |
...
| 4.9 | Memristive spill target for register file              | Research  | 4.6       | DONE    | —       |
...
| 5.9 | Native ternary hardware (Huawei CFET/CNTFET)   | Research  | 5.6-5.8  | DONE    | —      |
